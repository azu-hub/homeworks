...
const vuzzChannels = {
  ...
  identity: {
    title: "ワーカー本人確認",
    subtitle: "ワーカーの本人確認と応募可否を確認",
    noticeTitle: "ワーカー本人確認キュー",
    noticeText: "書類不備、住所確認、重複アカウントの疑いを優先して確認します",
    metrics: [
      ["12", "確認待ち"],
      ["3", "再提出"],
      ["91%", "通過率"],
    ...
    heading: "ワーカー本人確認キュー",
    eyebrow: "worker identity",
    healthTitle: "確認状況",
    rows: [
      ["warn", "佐藤 美咲", "住所確認書類の文字が一部不鮮明", "再提出", "misaki"],
      ["", "田中 結衣", "氏名・住所・生年月日の照合待ち", "承認", ""],
  ...
  companyIdentity: {
    title: "企業確認",
    subtitle: "企業情報・担当者・掲載可否を確認",
    noticeTitle: "企業確認キュー",
    noticeText: "法人情報、担当者、掲載前の安全確認を行います",
    metrics: [
      ["6", "確認待ち"],
      ["2", "再確認"],
      ["94%", "通過率"],
    ...
    healthTitle: "企業確認状況",
    rows: [
      ["warn", "青葉ギフト", "法人番号と担当者情報の照合待ち", "承認"],
      ["", "北浜リサーチ", "所在地と連絡先の確認済み", "確認"],
      ["danger", "Nami EC Studio", "掲載条件と支払い方法の再確認が必要", "保留"],
    ],
    metricsSide: [
      ["企業確認待ち", "6件"],
      ["担当者確認", "2件"],
          ...
          : `
            ...
            <form class="onboarding-action" id="bankForm">
              ...
              <div class="form-grid">
                ...
                <label>
                  支店名
                  <input name="branchName" id="branchNameInput" type="text" placeholder="銀行を選択して支店一覧から選択" value="${escapeHtml(bankData.branchName)}" required />
                </label>
                <label>
                  口座種別
